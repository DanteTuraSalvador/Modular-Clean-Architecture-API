    ...
    ILogger<EstablishmentPhoneRepository> logger) : IEstablishmentPhoneRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            EstablishmentPhone? phoneResult = await _establishmentPhoneDbContext.Set<EstablishmentPhone>()
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            EstablishmentPhone? phoneToDelete = await _establishmentPhoneDbContext.Set<EstablishmentPhone>()

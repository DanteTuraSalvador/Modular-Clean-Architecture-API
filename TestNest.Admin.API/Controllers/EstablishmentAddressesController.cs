...
//            return CreatedAtAction(
//                nameof(GetAllEstablishmentAddresses),
//                new { establishmentAddressId = dto.EstablishmentAddressId }, dto);
//        }
...
//        {
//            return Ok(_mapper.Map<EstablishmentAddressResponse>(updatedAddress.Value!));
//        }

//        return HandleErrorResponse(updatedAddress.ErrorType, updatedAddress.Errors);
//    }
...
//            Result<EstablishmentAddress> singleAddressResult = await _establishmentAddressService.GetEstablishmentAddressByIdAsync(addressIdResult.Value!);

//            return singleAddressResult.IsSuccess && singleAddressResult.Value != null
//                ? Ok(_mapper.Map<EstablishmentAddressResponse>(singleAddressResult.Value))
//                : NotFound();
//        }
//        else
//        {
...
//        {
//            return Ok(_mapper.Map<EstablishmentAddressResponse>(patchedAddress.Value!));
//        }

//        return HandleErrorResponse(patchedAddress.ErrorType, patchedAddress.Errors);
//    }

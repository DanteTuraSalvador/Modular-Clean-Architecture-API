...
//            .ValidateAndCreateId<EstablishmentId>(establishmentContactForCreationRequest.EstablishmentId);
...
//            return CreatedAtAction(
//                nameof(GetAllEstablishmentContacts),
//                new { establishmentContactId = dto.EstablishmentContactId }, dto);
//        }
...
//        Result<EstablishmentId> establishmentIdResult = IdHelper
//            .ValidateAndCreateId<EstablishmentId>(establishmentContactForUpdateRequest.EstablishmentId);
//        if (!establishmentIdResult.IsSuccess)
//        {
//            return HandleErrorResponse(establishmentIdResult.ErrorType, establishmentIdResult.Errors);
//        }
...
//        if (updatedContact.IsSuccess)
//        {
//            return Ok(_mapper.Map<EstablishmentContactResponse>(updatedContact.Value!));
//        }
...
//        if (patchedContact.IsSuccess)
//        {
//            return Ok(_mapper.Map<EstablishmentContactResponse>(patchedContact.Value!));
//        }
...
//            Result<EstablishmentContact> singleContactResult = await _establishmentContactService.GetEstablishmentContactByIdAsync(contactIdResult.Value!);

//            return singleContactResult.IsSuccess && singleContactResult.Value != null
//                ? Ok(_mapper.Map<EstablishmentContactResponse>(singleContactResult.Value))
//                : NotFound();
//        }
//        else
//        {

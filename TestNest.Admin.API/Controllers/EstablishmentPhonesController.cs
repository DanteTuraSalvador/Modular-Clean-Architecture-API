    ...
    IErrorResponseService errorResponseService) : ControllerBase
{
    ...
    {
        Result<EstablishmentPhoneResponse> result = await _establishmentPhoneService.CreateEstablishmentPhoneAsync(creationRequest);

        if (result.IsSuccess)
        {
            return CreatedAtAction(nameof(GetAllEstablishmentPhones), new { establishmentPhoneId = result.Value!.EstablishmentPhoneId }, result.Value);
        }
        ...
        [FromBody] EstablishmentPhoneForUpdateRequest updateRequest)
    {
        ...
        Result<EstablishmentPhoneResponse> updatedPhoneResult = await _establishmentPhoneService.UpdateEstablishmentPhoneAsync(phoneIdResult.Value!, updateRequest);
...
//        [FromBody] EstablishmentPhoneForCreationRequest creationRequest)
//    {
//        Result<EstablishmentPhone> result = await _establishmentPhoneService.CreateEstablishmentPhoneAsync(creationRequest);

//        if (result.IsSuccess)
//        {
//            EstablishmentPhoneResponse dto = _mapper.Map<EstablishmentPhoneResponse>(result.Value!);
//            return CreatedAtAction(nameof(GetAllEstablishmentPhones), new { establishmentPhoneId = dto.EstablishmentPhoneId }, dto);
//        }
...
//        Result<EstablishmentPhone> updatedPhone = await _establishmentPhoneService.UpdateEstablishmentPhoneAsync(phoneIdResult.Value!, updateRequest);

//        if (updatedPhone.IsSuccess)
//        {
//            return Ok(_mapper.Map<EstablishmentPhoneResponse>(updatedPhone.Value!));
//        }

//        return HandleErrorResponse(updatedPhone.ErrorType, updatedPhone.Errors);
//    }
...
//        Result<EstablishmentPhone> patchedPhone = await _establishmentPhoneService.PatchEstablishmentPhoneAsync(phoneIdResult.Value!, patchRequest);

//        if (patchedPhone.IsSuccess)
//        {
//            return Ok(_mapper.Map<EstablishmentPhoneResponse>(patchedPhone.Value!));
//        }

//        return HandleErrorResponse(patchedPhone.ErrorType, patchedPhone.Errors);
//    }
...
//            Result<EstablishmentPhone> singlePhoneResult = await _establishmentPhoneService.GetEstablishmentPhoneByIdAsync(phoneIdResult.Value!);

//            return singlePhoneResult.IsSuccess && singlePhoneResult.Value != null
//                ? Ok(_mapper.Map<EstablishmentPhoneResponse>(singlePhoneResult.Value))
//                : NotFound();
//        }
//        else
//        {

...
using TestNest.Admin.Application.Mappings; // Add this using
...
using TestNest.Admin.SharedLibrary.Dtos.Responses; // You might not need this directly anymore
    ...
    IErrorResponseService errorResponseService) : ControllerBase
{
        ...
        [FromBody] EmployeeRoleForCreationRequest employeeRoleForCreationRequest)
    {
        ...
        if (result.IsSuccess)
        {
            EmployeeRoleResponse dto = result.Value!.ToEmployeeRoleResponse();
...
//        {
//            return Ok(_mapper
//                .Map<EmployeeRoleResponse>(updatedEmployeeRole.Value!));
//        }
...
//            return result.IsSuccess ? Ok(_mapper.Map<EmployeeRoleResponse>(result.Value!))
//                : HandleErrorResponse(result.ErrorType, result.Errors);
//        }
//        else
//        {

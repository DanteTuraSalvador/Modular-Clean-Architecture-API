    ...
    IErrorResponseService errorResponseService) : ControllerBase
{
        ...
        [FromBody] SocialMediaPlatformForCreationRequest socialMediaPlatformForCreationRequest)
    {
        ...
        if (result.IsSuccess)
        {
            var dto = result.Value!.ToSocialMediaPlatformResponse();
        ...
        [FromBody] SocialMediaPlatformForUpdateRequest socialMediaPlatformForUpdateRequest)
    {
        ...
        Result<SocialMediaPlatform> updatedSocialMediaPlatform = await _socialMediaPlatformService
        ...
        {
            return Ok(updatedSocialMediaPlatform.Value!.ToSocialMediaPlatformResponse());
        }
...
//        {
//            return Ok(_mapper
//                .Map<SocialMediaPlatformResponse>(
//                    updatedSocialMediaPlatform.Value!));
//        }
...
//            Result<SocialMediaPlatform> singlePlatformResult = await _socialMediaPlatformService
//                .GetSocialMediaPlatformByIdAsync(socialMediaIdValidatedResult.Value!);

//            return singlePlatformResult.IsSuccess
//                ? Ok(_mapper.Map<SocialMediaPlatformResponse>(singlePlatformResult.Value!))
//                : HandleErrorResponse(singlePlatformResult.ErrorType, singlePlatformResult.Errors);
//        }
//        else
//        {

    ...
    ILogger<EstablishmentContactService> logger) : BaseService(unitOfWork, logger, exceptionHandlerFactory), IEstablishmentContactService
{
    ...
    //    catch (Exception ex)
    //    {
    //        _logger.LogError(ex, "Error creating establishment contact.");
    //        return Result<EstablishmentContact>.Failure(ErrorType.Internal, [new Error("ServiceError", ex.Message)]);
    //    }
    //}
    ...
    //            }
    //            updatedContact = updatedContact.WithContactPerson(personNameResult.Value!).Value!;
    //            hasChanges = true;
    //        }
    ...
    //                updatedContact = updatedContact.WithPrimaryFlag(true).Value!;
    //                hasChanges = true;
    //            }
    //            else
    //            {
    //                updatedContact = updatedContact.WithPrimaryFlag(false).Value!;
    //                hasChanges = true;
    //            }
    //        }
    ...
    //    catch (Exception ex)
    //    {
    //        _logger.LogError(ex, "Error updating establishment contact.");
    //        return Result<EstablishmentContact>.Failure(ErrorType.Internal, new Error("ServiceError", ex.Message));
    //    }
    //}
    ...
    //    catch (Exception ex)
    //    {
    //        _logger.LogError(ex, "Error patching establishment contact.");
    //        return Result<EstablishmentContact>.Failure(ErrorType.Internal, [new Error("ServiceError", ex.Message)]);
    //    }
    //}
